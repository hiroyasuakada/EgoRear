...
class Ego4ViewRWHeatmapDataset(Dataset, metaclass=ABCMeta):
    def __init__(
        self,
        data_root,
        info_json,
        **kwargs
        ...
        super(Ego4ViewRWHeatmapDataset, self).__init__()
        ...
        for line_idx, line in enumerate(lines):
            ...
            for frame_path in list_frame_path:
                ...
                if (self.camera_pos == "front") or (self.camera_pos == "all"):
                    data.append((frame_path, 0))
                    data.append((frame_path, 1))

                elif (self.camera_pos == "back") or (self.camera_pos == "all"):
                    data.append((frame_path, 2))
                    data.append((frame_path, 3))
